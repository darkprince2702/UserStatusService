...
${OBJECTDIR}/Checkpoint.o: Checkpoint.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Checkpoint.o Checkpoint.cpp
...
${OBJECTDIR}/UserStatusServiceServer.o: UserStatusServiceServer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UserStatusServiceServer.o UserStatusServiceServer.cpp

${OBJECTDIR}/userstatusservice_constants.o: userstatusservice_constants.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/userstatusservice_constants.o userstatusservice_constants.cpp

${OBJECTDIR}/userstatusservice_types.o: userstatusservice_types.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/userstatusservice_types.o userstatusservice_types.cpp
